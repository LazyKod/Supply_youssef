      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-8">
          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
            <h3 className="text-sm font-semibold text-slate-700 mb-2">Identifiants de test :</h3>
            <div className="text-xs text-slate-600 space-y-1">
              <p><strong>Admin:</strong> admin@armor.com / password</p>
              <p><strong>Utilisateur:</strong> user@armor.com / password</p>
            </div>
          </div>
        </div>
